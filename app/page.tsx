...
function buildContactHref(
  ...
  const value = siteConfig.contact[platform];
  ...
  if (platform === "email") {
    return `mailto:${value}?subject=${encodeURIComponent(content[locale].contact.emailSubject)}&body=${encodeURIComponent(message)}`;
  }
    ...
    <main>
      <header className="site-header">
        <div className="header-inner container">
          <a className="brand" href="#top" aria-label={`${siteConfig.brandName} home`}>
              ...
              <article className="lesson-card" key={lesson.id} data-reveal>
                <div className="card-image">
                  <img
                    ...
                    height="480"
                  />
                  <span>{t.common.photoPlaceholder}</span>
                </div>
      ...
      <section id="booking" className="section booking-section">
        <div className="container">
          ...
          <aside className="booking-alert" data-reveal>
            <span aria-hidden="true">!</span>
            <p>{t.booking.alert}</p>
          </aside>
        </div>
        ...
        <div className="container contact-panel" data-reveal>
          ...
          <div className="contact-actions">
            {contactPlatforms.map((platform) => {
              const href = buildContactHref(platform.key, locale);
              ...
              return href ? (
                <a
                  ...
                  rel={platform.key === "email" ? undefined : "noreferrer"}
                >
                  <span>{label}</span>
                  <i aria-hidden="true">↗</i>
                </a>
          ...
          <p className="prefill-preview">
            <strong>{t.contact.prefillLabel}</strong>
            {siteConfig.prefilledMessage[locale]}
          </p>
        </div>
      </section>
